...
def parse_args():
    ...
    parser.add_argument(
        ...
        # default = "codellama/CodeLlama-7b-hf ",
        # TODO!!:llama2 7b 鐨勫湴鏂?
        #default = "/public9_data/zs/zs/codellama/CodeLlama-13b-hf/",
        # default="/public9_data/zs/zs/CodeLlama-7b-hf/",
        # default = "/public9_data/zs/zs/codellama/CodeLlama-7b-Python-hf/",
        # default="/public9_data/zs/zs/CodeLlama-7b-hf/",
        #default="/public9_data/zs/zs/llama2_model/7b/",
        # default = "/public9_data/zs/zs/codellama/Llama2-13b-hf/",
        # default = "/public9_data/zs/zs/codellama/CodeLlama-13b-hf/",
        # default = "/public9_data/zs/zs/codellama/CodeLlama-34b-hf/",
        default = "/public13_data/zs/zs/codellama/vicuna-7b-v1.5/",
    ...
    parser.add_argument(
        "--metric_output_path",
        type=str,
        default="/public13_data/zs/new_bigcode/result/en-vicuna-7b-v1.5-hf.json",
    ...
    #TODO!!:将这里的default设置为："auto"可以对其进行自动分配到多个GPU上进行运行，default="auto"
...
def main():
    ...
    if args.load_generations_path:
        ...
        tokenizer = AutoTokenizer.from_pretrained(
            ...
            #TODO!!:跑chatglm时需要将其设置为padding_side="left"
            padding_side="right",
